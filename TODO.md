...
- [ ] **B27 — dédoublonnage** (non appliqué, > 3 fichiers) : **avis rédigé le 2026-09-06, en attente de validation** → `docs/avis/AVIS_DEDOUBLONNAGE_HELPERS.md` (9 fichiers, ≈ −35 lignes, zéro changement de comportement, à livrer seul en v0.12.5 après le déploiement de v0.12.4).
