...
- [ ] **B29 — cascades atomiques** : **avis rédigé le 2026-09-06, en attente de validation** → `docs/avis/AVIS_CASCADES_ATOMIQUES.md` (phase 1 = `io.js` seul, v0.12.7 : lire d'abord, écrire en une transaction multi-stores ; `restaurer`, cascades et `importerJSON` tout-ou-rien ; phase 2 = 3 modules).
