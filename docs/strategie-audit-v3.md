...
> **État au 2026-09-15 (v0.12.20)** : V3-01 (lot V3-A, v0.12.15), V3-02 et V3-03 (V3-B1, V3-B2), V3-04 (V3-D) et V3-05 (V3-C1) sont corrigés — les trois derniers repris de la copie de travail de Codex. **V3-B3**, le piège du barème, est traité sur la branche `grilles-schema3` (v0.13.0) : l'application demande s'il faut convertir les notes, garder les points ou annuler.
