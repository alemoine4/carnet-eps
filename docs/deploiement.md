...
|---|---|---|---|
| v0.13.3 | `v0.13.3` | *(à compléter au commit)* (branche `grilles-schema3`) | **Mise en service de la nouvelle adresse** après validation de l’essai téléphone : `MODE_ESSAI = false`, manifeste « Carnet EPS » ; publiée en même temps que la v0.12.22 (bandeau « a déménagé ») sur l’ancienne adresse — schéma 3 inchangé |
