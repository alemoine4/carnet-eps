...
|---|---|---|---|
| v0.12.22 | `v0.12.22` (à poser au déploiement) | branche `demenagement` | **Bandeau « Carnet EPS a déménagé »** pour l’ANCIENNE adresse, à publier une fois la nouvelle installation en place (audit A01) : renseigner l’adresse HTTPS dans `app/js/demenagement.js` avant le déploiement ; 5 tests, suite 221 — **préparée, NON déployée** |
