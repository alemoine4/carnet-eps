...
|---|---|---|---|
| v0.12.21 | `v0.12.21` | *(à compléter au commit)* | **Statuts d’appel distinguables** (retour de terrain du 2026-09-16), reportés de la v0.13.2 : retard en pastille jaune vif, oubli de tenue en magenta, dispense en indigo ; écart perceptuel ≥ 34 entre les statuts les plus lus, ≥ 18 sur la palette, contrastes conservés ; même pastille dans la fiche élève ; 4 tests (dont le thème sombre automatique), 5 mutants tués, suite 220 — schéma 2 inchangé, version réversible |
