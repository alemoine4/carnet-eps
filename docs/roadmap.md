...
- 🔲 **5e audit** (2026-09-07, `docs/audit-2026-09-07.md`) — Codex V2 + 13 lentilles Opus : 179 constats (9 P1) ; plan en 5 lots (v0.12.9 → v0.12.12) et décisions structurantes (A01 origine dédiée, CI) — **en attente de GO**.
