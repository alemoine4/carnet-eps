...
- ✅ **4e audit, 12 lentilles** (2026-09-05, rapport `docs/audit-2026-09-05.md`) — 34 constats, 30 traités en **v0.12.4** (grille d'appel 2 colonnes à 360 px, import JSON sûr, élève « parti », contrastes du thème sombre…) + 25 tests de non-régression (`regressions.spec.mjs`, suites ci-dessous comprises) — **déployée le 2026-09-06** ; suites livrées et déployées le même jour : B27 dédoublonnage (**v0.12.5**, avis validé), B30 vision par trimestre (**D012, v0.12.6**), B29 cascades atomiques (**v0.12.7**, avis validé) ; reliquat : B31 clavier virtuel (à valider sur Android).
- ✅ **Suites de la stratégie Codex** (2026-09-06) — 5 hypothèses démontrées → avis `docs/avis/AVIS_DURABILITE_ECRITURES.md` validé et livré en **v0.12.8** (écritures durables, caches préfixés, purge et export cohérents, doublons refusés).
- 🔶 **5e audit** (2026-09-07, `docs/audit-2026-09-07.md`) — Codex V2 + 13 lentilles Opus : 179 constats (9 P1) ; plan en 5 lots (v0.12.9 → v0.12.12) et décisions structurantes (A01 origine dédiée, CI). ✅ **Lot 1 livré en v0.12.9** le 2026-09-07 (44 constats : exactitude de l'appel, seuil annuel partout, validations, erreurs visibles, import plus strict ; 43 tests, revue adversariale, décision D013). ✅ **Lot 3 livré en v0.12.10** le 2026-09-07 (35 constats : focus, lecteur d'écran, vrais tableaux, notifications, 320 px, contraste, impression ; 25 tests, revue adversariale). ✅ **Lot 4 livré en v0.12.11** le 2026-09-08 (17 constats : service-worker durci à stratégie constante, lectures par index en une transaction, plafond des pièces, PWA ; 11 tests dont 4 avec le service-worker réel, revue adversariale en deux passes). ✅ **Lot 5 livré en v0.12.12** le 2026-09-08 (63 constats : données et CSV, import, appel/notes, qualité, sécurité, config et couverture des tests, docs ; 35 tests, suite 153). **Avis en attente** : `AVIS_LOT5_RESTES.md` (9 points, dont barème modifiable, dates avec année, observations sur l'écran d'appel, projet mobile Playwright). **Avis rédigés, en attente** : lot 2 créations atomiques (`docs/avis/AVIS_CREATIONS_ATOMIQUES.md`), A01 origine dédiée (`docs/avis/AVIS_ORIGINE_DEDIEE.md`). ✅ **Lot 2 livré en v0.12.13** le 2026-09-09 (créations atomiques : V2-06, D-04, D-06 ; 5 tests, suite 158) avec l’**intégration continue** GitHub Actions (C64) — **les 5 lots du 5e audit sont livrés**. ✅ **v0.12.14** le 2026-09-09 : A39 et les points retenus de l’avis du lot 5 (C15, C45, A33, D-08 (3), A34, A31, C60) — **le 5e audit est entièrement soldé**, sauf les deux points écartés (C44 (1), C16 (2)) ; **A01 (origine dédiée) attend une décision de l’utilisateur** (réinstallation et migration sur chaque appareil).
