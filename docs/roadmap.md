...
- 🔲 **Suites de la stratégie Codex** (`audit codex/STRATEGIE_AUDIT.md`, 2026-09-06) — 5 hypothèses vérifiées et démontrées (durabilité des écritures, caches d'origine partagée, purge, export, doublons à l'import) → avis `docs/avis/AVIS_DURABILITE_ECRITURES.md` (v0.12.8, en attente de validation).
