...
- ✅ **4e audit, 12 lentilles** (2026-09-05, rapport `docs/audit-2026-09-05.md`) — 34 constats, 30 traités en **v0.12.4** (grille d'appel 2 colonnes à 360 px, import JSON sûr, élève « parti », contrastes du thème sombre…) + 20 tests de non-régression — **déployée le 2026-09-06** ; suites livrées et déployées le même jour : B27 dédoublonnage (**v0.12.5**, avis validé), B30 vision par trimestre (**D012, v0.12.6**), B29 cascades atomiques (**v0.12.7**, avis validé) ; reliquat : B31 clavier virtuel (à valider sur Android).
